      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            animate={{ y: [null, -30, 30, -30], x: [null, 30, -30, 30] }}
      ...
      >
        ...
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold mb-2">
            Welcome <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Back</span>
          </h2>
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-purple-100"
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition ${
                    errors.email ? 'border-red-500' : 'border-purple-100'
                  } bg-white/50`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-12 py-3 border-2 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition ${
                    errors.password ? 'border-red-500' : 'border-purple-100'
                  } bg-white/50`}
                  placeholder="••••••"
                />
                <button
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm text-purple-600 hover:text-purple-700 transition">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-2 border-2 border-purple-200 rounded-xl hover:bg-purple-50 transition text-gray-700">
        ...
        <p className="text-center text-gray-600">
          ...
          <Link to="/register" className="text-purple-600 hover:text-purple-700 font-semibold transition">
            Sign up
          </Link>
        </p>
